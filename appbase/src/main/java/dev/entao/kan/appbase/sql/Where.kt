...
infix fun KProperty<*>.LIKE(value: String): Where {
	return this.userName.LIKE(value)
}
...
infix fun KProperty<*>.IN(values: Collection<Any>): Where {
	return this.userName.IN(values)
}
